...
const setSearchingHandler = (val) => {
  ...
  return (
    <div className='wrapper'>
      <Navbar setSearching={setSearchingHandler}/>
      <Notes notes={filteredNotes} deleteNote={deleteNoteHandler} changeNote={changeNoteHandler} />
      {isModalOpen && (
        <Modal closeModal={closeModalHandler} addOrChangeNote={addOrChangeNoteHandler} edit={isEdit} editNote={editNote}/>
      )}
      {!isModalOpen && (
